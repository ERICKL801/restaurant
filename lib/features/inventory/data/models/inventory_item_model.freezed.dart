...
class _$InventoryItemModelImpl extends _InventoryItemModel {
  ...
  @override
  String toString() {
    return 'InventoryItemModel(id: $id, name: $name, category: $category, unit: $unit, currentStock: $currentStock, minimumStock: $minimumStock, costPrice: $costPrice, active: $active)';
  }
